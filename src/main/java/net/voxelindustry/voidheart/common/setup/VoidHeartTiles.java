...
{
    public static BlockEntityType<PocketPortalTile> POCKET_PORTAL;
    public static BlockEntityType<PortalWallTile>   PORTAL_WALL;

    public static void registerTiles()
    {
        registerTile(POCKET_PORTAL =
                        BlockEntityType.Builder.create(PocketPortalTile::new, VoidHeartBlocks.POCKET_PORTAL).build(null),
